app.controller("SearchCtrl", ["$q", "$http", "$scope", "search-factory",
  function($q, $http, $scope, searchstorage) {
    

    

       var getPhotos = $q(function(resolve, reject) {
         $http.get('https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=43bea15728db44fd9518bfe94f8527bb&format=json&nojsoncallback=1&text=cat&extras=url_o')        
           .success(
